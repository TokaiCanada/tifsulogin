function formatSPH(input) {
  ...
  if (number > 0 && !formattedValue.startsWith("+") && !formattedValue.startsWith("-")) {
...
document.querySelectorAll('.r-l-data-table input[id^="sph"]').forEach(input => {
